  ...
  useEffect(() => {
    const fetchFarms = async () => {
      try {
        ...
        const response3 = await PublicFarmService.getFarmsByProductId(
        ...
        const allFarms = {
          ...
          allProductFarms: response3.data.filter(
            (farm) => !farms.find((f) => f.farm_id === farm.farm_id)
          ), // Exclude farms already fetched in previous responses
        };
      ...
      <div className="row order-details">
        <div className="col-md-6">
          <div className="order-details-container">
            ...
            <p>
              Quantity Required: {order.quantity_requested}{" "}
              {order.product_id.unit}
            </p>
                  ...
                  >
                    ...
                    <div className="product">
                      ...
                      <div className="text">
                        ...
                        <p className="button">
                          <a href="customer/chat" className="btn btn-default">
                            Chat Farmer
                          </a>
